...
if (_companySelector in _charlie or _alwaysAvalible) then {
    ...
    [_object,"Machinegun Team Lead", "CAV_Charlie_Machinegunner_TeamLeader_Local", "", _charlieMMGTeamCat, "Charlie", _allowOnlyForCompany] call FUNC(addQuickSelection);
    [_object,"Machinegunner", "CAV_Charlie_Machinegunner_Local", "", _charlieMMGTeamCat, "Charlie", _allowOnlyForCompany] call FUNC(addQuickSelection);
    [_object,"Grenadier", "Cav_B_C_Grenadier_F", "", _charlieMMGTeamCat, "Charlie", _allowOnlyForCompany] call FUNC(addQuickSelection);
    [_object,"Assistant Gunner", "CAV_Charlie_Machinegunner_AG", "", _charlieMMGTeamCat, "Charlie", _allowOnlyForCompany] call FUNC(addQuickSelection);

    // MAAWS Team
    [_object,"cScriptQuickSelection_Charlie_ATTeam","SLM Team",_icon,["ACE_MainActions","cScriptQuickSelectionMenu","cScriptQuickSelection_Charlie"]] call FUNC(addAceCategory);
    ...
    [_object,"SLM Team Leader", "Cav_B_C_ATTL", "", _charlieATTeamCat, "Charlie", _allowOnlyForCompany] call FUNC(addQuickSelection);
    ...
    [_object,"SLM Gunner", "Cav_B_C_AT", "", _charlieATTeamCat, "Charlie", _allowOnlyForCompany] call FUNC(addQuickSelection);
    [_object,"SLM Ammo Bearer", "Cav_B_C_AAT", "", _charlieATTeamCat, "Charlie", _allowOnlyForCompany] call FUNC(addQuickSelection);

    // CCMS Team
    [_object,"cScriptQuickSelection_Charlie_CCMSTeam","CCMS Team",_icon,["ACE_MainActions","cScriptQuickSelectionMenu","cScriptQuickSelection_Charlie"]] call FUNC(addAceCategory);
    private _charlieCCMSTeamCat = ['ACE_MainActions','cScriptQuickSelectionMenu','cScriptQuickSelection_Charlie','cScriptQuickSelection_Charlie_CCMSTeam'];
    [_object,"CCMS Team Leader", "Cav_B_C_CCMSTL", "", _charlieCCMSTeamCat, "Charlie", _allowOnlyForCompany] call FUNC(addQuickSelection);
    [_object,"CCMS Gunner", "Cav_B_C_CCMS", "", _charlieCCMSTeamCat, "Charlie", _allowOnlyForCompany] call FUNC(addQuickSelection);
    [_object,"CCMS Ammo Bearer", "Cav_B_C_CCMSAB", "", _charlieCCMSTeamCat, "Charlie", _allowOnlyForCompany] call FUNC(addQuickSelection);
    ...
    [_object,"Stinger Team Leader", "Cav_B_C_AATL", "", _charlieAATeamCat, "Charlie", _allowOnlyForCompany] call FUNC(addQuickSelection);
