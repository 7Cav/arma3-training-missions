...
//Weapons Teams
//class Cav_B_C_Bravo_FireTeamLeader_F : Cav_B_C_FireTeamLeader_F {};
class B_HeavyGunner_F : CAV_Charlie_Machinegunner_TeamLeader_Local {};
class B_support_MG_F : CAV_Charlie_Machinegunner_Local {};
class B_support_AMG_F : CAV_Charlie_Machinegunner_AG {};
class B_soldier_AT_F : Cav_B_C_ATTL {};
class TF47_B_soldier_M3MAAWS : Cav_B_C_AT {};
class B_soldier_AAT_F : Cav_B_C_AAT {};
