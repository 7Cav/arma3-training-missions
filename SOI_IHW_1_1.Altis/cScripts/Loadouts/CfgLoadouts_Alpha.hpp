...
class Machingunner_TRG : CommonBlufor {
        ...
        secondary[] = {"","","","",""};
        launcher[] = {"","","","",""};
        magazines[] = {"rhsusf_100Rnd_762x51_m62_tracer",4,"rhsusf_100Rnd_762x51_m61_ap",2,"SmokeShell",2};
...
class MMG_TL_TRG : CommonBlufor {
        ...
        secondary[] = {"","","","",""};
        launcher[] = {"","","","",""};
        magazines[] = {"rhs_mag_30Rnd_556x45_M855A1_PMAG_Tracer_Red",8,"rhs_mag_m67",2,"SmokeShell",4,"SmokeShellYellow",2,"B_IR_Grenade","rhsusf_100Rnd_762x51_m62_tracer",5,"rhsusf_100Rnd_762x51_m61_ap",2};
        items[] = {"ACE_quikclot",16,"ACE_tourniquet",4,"ACE_MapTools","ACE_microDAGR","ACRE_PRC152_ID_2","rhsusf_ANPVS_14"};
...
class Assistant_Gunner_TRG : CommonBlufor {
        uniform[] = {"LOP_U_ISTS_Fatigue_19"};
        ...
        secondary[] = {"","","","",""};
        launcher[] = {"","","","",""};
        magazines[] = {"rhs_mag_30Rnd_556x45_M855A1_PMAG",8,"rhs_mag_m67",2,"SmokeShell",4,"rhsusf_100Rnd_762x51_m61_ap",2,"ACE_SpareBarrel","rhsusf_100Rnd_762x51_m62_tracer",5};
        items[] = {"ACE_quikclot",16,"ACE_tourniquet",4,"ACE_Flashlight_XL50","ACE_MapTools","ACE_DAGR","rhsusf_ANPVS_14"};
...
class AutomaticRifleman_TRG : CommonBlufor {
        uniform[] = {"LOP_U_ISTS_Fatigue_19"};
        vest[] = {"rhsusf_spcs_ocp_saw"};
        backpack[] = {"B_AssaultPack_mcamo"};
        primary[] = {"rhs_weap_m249_pip_S_para","rhsusf_acc_SFMB556","rhsusf_acc_anpeq15side_bk","rhsusf_acc_elcan_ard_3d",""};
        secondary[] = {"","","","",""};
        launcher[] = {"","","","",""};
        magazines[] = {"rhsusf_200rnd_556x45_mixed_box",5,"rhs_mag_m67",2,"SmokeShell",4};
        items[] = {"ACE_quikclot",16,"ACE_tourniquet",4,"ACE_Flashlight_XL50","ACE_MapTools","ACE_DAGR","rhsusf_ANPVS_14"};
        binoculars[] = {""};
        compass[] = {"ItemCompass"};
        goggles[] = {"rhsusf_oakley_goggles_clr"};
