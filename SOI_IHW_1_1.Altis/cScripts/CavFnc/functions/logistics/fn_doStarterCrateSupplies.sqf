...
if (_companySelector in _alpha or _alwaysAvalible) then {
    ...
    if (_companySelector in ['ALPHA', 'BUFFALO', 'TITAN', 'RAIDER', 'SPARROW' ] or _alwaysAvalible) then {
        ...
        _crate addWeaponCargoGlobal ["rhs_weap_m249_light_S",20];
        _crate addWeaponCargoGlobal ["rhs_weap_m240B",20];
        _crate addItemCargoGlobal ["rhsusf_acc_acog_mdo",20];
        _crate addItemCargoGlobal ["rhsusf_acc_elcan_ard",20];
        _crate addItemCargoGlobal ["rhsusf_acc_elcan_ard",20];
...
if (_companySelector in _bravo or _alwaysAvalible) then {
    ...
    if (_companySelector in ['BRAVO', 'MUSTANG'] or _alwaysAvalible) then {
        ...
        _crate addItemCargoGlobal ["tf47_at4_HP",250];
        _crate addItemCargoGlobal ["tf47_at4_heat",250];
        _crate addItemCargoGlobal ["tf47_at4_HEDP",250];
        _crate addItemCargoGlobal ["tf47_m3maaws",20];
        _crate addItemCargoGlobal ["tf47_optic_m3maaws",20];

        //================== AMMO ==================\\

        _crate addMagazineCargoGlobal ["tf47_m3maaws_HE",250];
        _crate addMagazineCargoGlobal ["tf47_m3maaws_HEAT",250];
        _crate addMagazineCargoGlobal ["tf47_m3maaws_HEDP",250];
        _crate addMagazineCargoGlobal ["tf47_m3maaws_SMOKE",250];
        _crate addMagazineCargoGlobal ["tf47_m3maaws_ILLUM",250];
...
if (_companySelector in _charlie or _alwaysAvalible) then {
    ...
    _crate addItemCargoGlobal ["rhs_weap_fgm148",20];
    _crate addItemCargoGlobal ["rhs_weap_fim92",20];

    //================== AMMO ==================\\

    _crate addMagazineCargoGlobal ["rhs_fgm148_magazine_AT",250];
    _crate addMagazineCargoGlobal ["rhs_fim92_mag",250];
