...
_vehicle addMagazineCargoGlobal ["rhs_mag_30Rnd_556x45_M855A1_PMAG", 96];
_vehicle addMagazineCargoGlobal ["rhs_mag_30Rnd_556x45_M855A1_PMAG_Tracer_Red", 32];
_vehicle addMagazineCargoGlobal ["rhsusf_200rnd_556x45_mixed_soft_pouch", 24];
_vehicle addMagazineCargoGlobal ["rhs_mag_m67", 32];
_vehicle addMagazineCargoGlobal ["SmokeShell", 64];
_vehicle addMagazineCargoGlobal ["SmokeShellBlue", 8];
_vehicle addMagazineCargoGlobal ["ACE_Chemlight_IR", 16];
_vehicle addMagazineCargoGlobal ["rhs_mag_M433_HEDP", 64];
_vehicle addMagazineCargoGlobal ["rhs_mag_m713_Red", 16];
_vehicle addMagazineCargoGlobal ["ACE_40mm_Flare_ir", 16];
_vehicle addMagazineCargoGlobal ["ACE_HuntIR_M203", 8];
