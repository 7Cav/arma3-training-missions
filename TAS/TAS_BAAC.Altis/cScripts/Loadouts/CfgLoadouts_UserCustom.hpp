...
class Cav_B_Training_Cadet_F : CommonBlufor {
    ...
    scope = 1;
    category[] = {"cScripts_Loadout_Cat_Other"};
    loadout = [["rhs_weap_m4a1_grip3","rhsusf_acc_SFMB556","rhsusf_acc_anpeq15_top","rhsusf_acc_compm4",[],[],"rhsusf_acc_tdstubby_tan"],[],[],["rhs_uniform_acu_oefcp",[["ACE_quikclot",14],["ACE_tourniquet",4],["ACE_Flashlight_XL50",1],["ACE_MapTools",1],["ACRE_PRC343",1],["ACE_DAGR",1]]],["rhsusf_spcs_ocp_rifleman_alt",[]],["B_AssaultPack_mcamo",[["ACE_personalAidKit",1],["rhsusf_ANPVS_14",1],["ACE_EntrenchingTool",1]]],"rhsusf_ach_helmet_camo_ocp","rhsusf_oakley_goggles_clr",[],["ItemMap","","","ItemCompass","ItemWatch",""]];
    //insignia = "";
