...
class Cav_B_B_PlatoonMedic_F : Cav_B_Bravo_base_F {
    uniform[] = {"LOP_U_ISTS_Fatigue_19"};
        ...
        primary[] = {"rhs_weap_m4a1_grip","","rhsusf_acc_anpeq15side","rhsusf_acc_compm4","rhsusf_acc_grip1"};
        secondary[] = {"rhsusf_weap_m9","","","",""};
        launcher[] = {"","","","",""};
        magazines[] = {"rhs_mag_30Rnd_556x45_M855A1_Stanag",7,"rhsusf_mag_15Rnd_9x19_JHP",2,"rhs_mag_m67","SmokeShell",2,"SmokeShellRed",4,"SmokeShellPurple",8};
        items[] = {"ACE_adenosine",5,"ACRE_PRC152","ACRE_PRC152","ACE_MapTools","ACE_CableTie","ACE_microDAGR","ACE_EntrenchingTool","ACE_tourniquet",13,"ACE_personalAidKit",6,"ACE_surgicalKit","ACE_quikclot",40,"ACE_elasticBandage",40,"ACE_epinephrine",20,"ACE_morphine",20,"ACE_salineIV",4,"ACE_salineIV_500",4,"ACE_IR_Strobe_Item",2};
        binoculars[] = {"ACE_Vector"};
        compass[] = {"ItemCompass"};
