...
_box addAction ["  <t color='#155492'><img size='1' image='\a3\ui_f\data\Map\VehicleIcons\iconManOfficer_ca'/></t>Squad Leader", {
    params ["","_player"];

    if (typeOf _player == "Cav_B_Training_Cadet_F") then {
        _player allowDamage false
    };
