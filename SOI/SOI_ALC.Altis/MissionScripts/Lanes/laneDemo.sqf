...
_box addAction ["<t color='#FF00FF'>Lane 6 ACE Hint</t>", {
		...
		private _ammoTxt = composeText [
			...
			parseText"Your team is beginning to run low on 5.56mm magazines<br />Your team is beginning to run low on 5.56mm belts<br />Your team is beginning to run low on 40mm HE and Smoke Grenades<br />Your team is mostly full on all other ammunition<br />"
		];
		private _casualtyTxt = composeText [
			image _casualtyImg, parseText " Casualties<br />",
			parseText"No one has been injured<br />"
		];
		private _equipTxt = composeText [
			image _equipImg, parseText " Equipment<br />",
			parseText"You have accountability for all radios, binos, and nods<br />You are full on medical supplies<br />"
		];
