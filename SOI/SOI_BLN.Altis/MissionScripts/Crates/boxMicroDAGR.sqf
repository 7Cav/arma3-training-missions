...
[missionNameSpace, ["lockedMicroDAGR", true]] remoteExec ["setvariable", 0, true];
...
_box addAction ["  <t color='#ff0000'><img size='1' image='\a3\ui_f\data\IGUI\Cfg\simpleTasks\types\getout_ca'/>Lock Crate</t>", {
    ...
    true,
    "",
    "!(missionNameSpace getVariable ['lockedMicroDAGR', true]) && (player getVariable ['instructor',false])", // _target, _this, _originalTarget
    5,
    false,
    "",
    ""
...
_box addAction ["  <t color='#00ff00'><img size='1' image='\a3\ui_f\data\IGUI\Cfg\simpleTasks\types\getin_ca'/>Unlock Crate</t>", {
        ...
        [missionNameSpace, ["lockedMicroDAGR", false]] remoteExec ["setvariable", 0, true];
    },
    nil,
    1.5,
    true,
    true,
    "",
    "(missionNameSpace getVariable ['lockedMicroDAGR', false]) && (player getVariable ['instructor',false])", // _target, _this, _originalTarget
    5,
    false,
    "",
    ""
